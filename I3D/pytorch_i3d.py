...
This code is adapted from the following repository:
    https://github.com/alanjeremiah/WLASL-Recognition-and-Translation/blob/main/WLASL/I3D/pytorch_i3d.py

This code is used to load the I3D model for the SLAMM project.
Version: 02/06/2025
"""
